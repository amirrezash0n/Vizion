...
export default function NotFound() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-balticSea-400 p-6 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-6 max-w-md w-full text-center relative z-10">
        <div className="relative">
          <h1 className="font-morabbaBold text-[160px] leading-none text-primary/20 select-none">
            ۴۰۴
          </h1>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="flex items-center justify-center w-20 h-20 rounded-full bg-balticSea-300 border border-white-5 shadow-lg">
              <FiAlertCircle size={36} className="text-primary" />
            </div>
          </div>
        </div>

        <div className="space-y-3 -mt-4">
          <h2 className="font-yekanBold text-2xl text-whiteSmoke">
            صفحه‌ای که دنبالش بودی پیدا نشد!
          </h2>
          <p className="font-morabbaMedium text-sm text-dawn leading-relaxed">
